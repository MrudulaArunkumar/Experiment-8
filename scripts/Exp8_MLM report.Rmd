...
#                       binomial,
#                       na.action = "na.omit")
tab_model(randomSlopes_m2_err,randomSlopes_m1_err, show.se = TRUE, show.ci = FALSE, show.p = TRUE, show.stat = TRUE, show.aic = TRUE, show.loglik = TRUE, dv.labels = "Error Rate")
...
randomSlopes_m3<-lmer(RT_io~1+val*sal*previous_rm_cwp*Distance_cwp+(1+val*sal*previous_rm_cwp*Distance_cwp|participant), 
                      ...
                      REML=F,
                      na.action = "na.omit")
tab_model(randomSlopes_m3, show.se = TRUE, show.p = TRUE, show.ci = FALSE, show.stat = TRUE, show.aic = TRUE, show.loglik = TRUE)
plot_model(randomSlopes_m3, type = "pred", group.terms = "previous_rm_cwp", terms = c("sal","val[minmax]","Distance_cwp","previous_rm_cwp"))
...
tab_model(randomSlopes_m3_err, show.se = TRUE, show.p = TRUE, show.ci = FALSE, show.stat = TRUE, show.aic = TRUE, show.loglik = TRUE, dv.labels = "Error Rate")
