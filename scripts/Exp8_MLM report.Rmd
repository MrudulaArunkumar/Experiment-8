...
## 3. Model4 : Adding the level 2 interaction factors
...
randomSlopes_m4<-lmer(RT_io~1+val*sal*previous_rm_cwp*Distance_cwp+(1+val*sal* previous_rm_cwp*Distance_cwp|participant), 
                      ...
                      REML=F,
                      na.action = "na.omit")
tab_model(randomSlopes_m4, show.ci = FALSE, show.stat = TRUE, show.aic = TRUE, show.loglik = TRUE)
...
tab_model(randomSlopes_m4_err, show.ci = FALSE, show.stat = TRUE, show.aic = TRUE, show.loglik = TRUE)
...
tab_model(randomSlopes_m2,randomSlopes_m2_err,randomSlopes_m4,randomSlopes_m4_err, show.ci = FALSE, show.stat = TRUE, show.aic = TRUE, show.loglik = TRUE)
```
