...
**This report highlights the results from the Multi level analysis for Experiment 8 and only for participants without awareness.**
...
The prepared dataset is saved as  *Exp8_withoutawareness.csv* and is loaded to perform the MLM.
...
raw.data<-read.csv(here("Data","Exp8_withoutawareness.csv"))
